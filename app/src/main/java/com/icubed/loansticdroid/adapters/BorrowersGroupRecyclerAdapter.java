...
public class BorrowersGroupRecyclerAdapter extends RecyclerView.Adapter<BorrowersGroupRecyclerAdapter.ViewHolder> {

    List<GroupBorrowerTable> groupBorrowerTables;
    Context context;

    public BorrowersGroupRecyclerAdapter(List<GroupBorrowerTable> groupBorrowerTables) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.borrower_group_single_layout, parent, false);
