...
public class SavingsPlanLifeGoals extends AppCompatActivity {
    ...
    private static final String TAG = ".SavingsPlanLifeGoals";
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful()){
                            if(!task.getResult().isEmpty()) {
                                ...
                                hideProgressBar();
                                Toast.makeText(SavingsPlanLifeGoals.this, "No available loan types", Toast.LENGTH_SHORT).show();
                            }

                        }else{
                            Toast.makeText(SavingsPlanLifeGoals.this, "Failed to retrieve loan types", Toast.LENGTH_SHORT).show();
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if(selectedSavingsPlanTypeTable != null){
