...
public class ScalingTextureView extends TextureView {
    ...
    public void setAspectRatio(int width, int height, int screenWidth, int screenHeight) {
        ...
        mRoundedScreenAspectRatio = format("%.2f", mScreenAspectRatio);
        mRoundedPreviewAspectRatio = format("%.2f", mPreviewAspectRatio);
        getWidthCorrection();
    }
    ...
    private void getWidthCorrection(){
        @SuppressLint("DefaultLocale") String roundedScreenAspectRatio = format("%.2f", mScreenAspectRatio);
        @SuppressLint("DefaultLocale") String roundedPreviewAspectRatio = format("%.2f", mPreviewAspectRatio);
